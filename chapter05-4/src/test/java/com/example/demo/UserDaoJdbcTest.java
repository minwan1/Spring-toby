...
public class UserDaoJdbcTest {
    ...
    public void setUp() throws Exception {
        ...
        this.user1 = new User("gyumee", "박성철", "springno1", Level.BASIC, 1, 0, "test1@naver.com");
        this.user2 = new User("leegw700", "이길원", "springno2", Level.SILVER, 55, 10, "test2@naver.com");
        this.user3 = new User("bumjin", "박범진", "springno3", Level.GOLD, 100, 40, "test3@naver.com");
    }
